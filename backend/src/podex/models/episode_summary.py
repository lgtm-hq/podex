"""Episode derivative summary model."""
...
class EpisodeSummary(Base):
    """Read-optimized narrative derivative for a podcast episode."""

    __tablename__ = "episode_summaries"
    __table_args__ = (
        UniqueConstraint("summary_key", name="uq_episode_summaries_summary_key"),
    )
