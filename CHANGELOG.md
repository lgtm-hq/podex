...
- **release**: cap version bumps at minor until 1.0 (#381) (3d0e8a0)
- **config**: final nested-settings sweep for env examples and docs (#380) (9cb24d8)
- **enrichment**: key routing tables on MediaType and drop wikipedia fallback set (#379)
  (f160a47)
- **release**: version 1.0.0 (#378) (aac91c2)
...
- **extraction**: add LLM extraction workflow behind the prompt injection seam (#253)
  (a7604cd)
